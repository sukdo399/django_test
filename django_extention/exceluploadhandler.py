from django_extention.uploadhandler import RelativePathTemporaryFileUploadHandler
from django_extention.uploadhandler import RelativePathMemoryFileUploadHandler

from django_extention.uploadedfile import InMemoryUploadedFile
from django_extention.uploadedfile import TemporaryUploadedFile
...
class ExcelMemoryFileUploadHandler(RelativePathMemoryFileUploadHandler):
    """
...
class TemporaryExcelFileUploadHandler(RelativePathTemporaryFileUploadHandler):
    """
    ...
    def new_file(self, file_name, *args, **kwargs):
        ...
        """
        super(RelativePathTemporaryFileUploadHandler, self).new_file(
            file_name,
            *args,
            **kwargs)
        custom_args = [
